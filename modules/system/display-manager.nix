  ...
  services.greetd = {
    ...
    settings = {
      default_session = {
        ...
        command = "${inputs.mango.packages.${pkgs.system}.mango}/bin/mango -s '${pkgs.quickshell}/bin/qs -p /home/shinyu/nixfiles/configs/quickshell/greetd/shell.qml'";
        user = "greeter";
      };
    };
  };
  users.users.greeter.extraGroups = [ "users" "video" "input" ];
