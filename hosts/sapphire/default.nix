...

{
  ...
  boot.loader.systemd-boot.windows.Win11 = {
    title = "Windows";
    #path = "HD0c:/EFI/Microsoft/Boot/bootmgfw.efi";
  ...
  services.xserver.xkb.layout = "us,dz";
  ...
  #  enable = true;
  #  user = "shinyu";
  #  directory = config.users.users.shinyu.home;
  #  files = {
  #    ".config/matugen/" = {
  #    }
  #  }
